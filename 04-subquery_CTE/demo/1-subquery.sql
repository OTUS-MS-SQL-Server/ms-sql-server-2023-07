...
SELECT *
FROM Application.People p
WHERE PersonId in (SELECT distinct SalespersonPersonID  FROM Sales.Invoices i
...
SELECT *
FROM Application.People p
WHERE PersonId in (SELECT SalespersonPersonID  FROM Sales.Invoices i);

SELECT *
FROM Application.People p
WHERE exists (SELECT top 1 1 FROM Sales.Invoices i
where i.SalespersonPersonID = p.PersonID);

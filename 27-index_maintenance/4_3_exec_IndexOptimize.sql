...
exec master.dbo.IndexOptimize
	...
	@FragmentationHigh = 'INDEX_REBUILD_ONLINE, INDEX_REORGANIZE', --попробовать перестроить онлайн, если не получится - реорганизовать (возможные значения можно посмотреть в тексте хп)

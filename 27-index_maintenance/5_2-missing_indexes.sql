USE WideWorldImporters;
 ...
 -- Запрос с missing indexes см. план запроса
 --"Зеленая подсказка" Showplan - индексы, помогающие только текущему запросу
...
-- долго!!! отключить план запроса 
-- собираем данные для использования кода
declare @q date;

SELECT @q = InvoiceDate
FROM Sales.Invoices
